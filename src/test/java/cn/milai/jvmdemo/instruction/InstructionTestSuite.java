...
import cn.milai.jvmdemo.instruction.natives.NativesTestSuite;
...
@SuiteClasses(
	{ ByteCodeReaderTest.class, InstructionFactoryTest.class, ConstantInstructionTestSuite.class,
		...
		ReferenceTestSuite.class, CompareInstructionTestSuite.class, ExtendedTestSuite.class, NativesTestSuite.class }
)
