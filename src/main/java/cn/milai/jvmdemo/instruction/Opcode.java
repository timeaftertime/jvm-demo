...
public enum Opcode {
	...
	LCONST_0(0x09), LCONST_1(0x0a), FCONST_0(0x0b), FCONST_1(0x0c), FCONST_2(0x0d),
	...
	IALOAD(0x2e), LADLOAD(0x2f), FALOAD(0x30), DALOAD(0x31), AALOAD(0x32), BALOAD(0x33), CALOAD(0x34), SALOAD(0x35),
	...
	I2L(0x85), I2F(0x86), I2D(0x87), L2I(0x88), L2F(0x89), L2D(0x9a),
	F2I(0x9b), F2L(0x8c), F2D(0x8d), D2I(0x8e), D2L(0x8f), D2F(0x90),
	I2B(0x91), I2C(0x92), I2S(0x93),
	LCMP(0x94), FCMPL(0x95), FCMPG(0x96), DCMPL(0x97), DCMPG(0x98),
	IFEQ(0x99), IFNEG(0x9a), IFLT(0x9b), IFGE(0x9c), IFGT(0x9d), IFLE(0x9e),
	IF_ICMPEQ(0x9f), IF_ICMPNE(0xa0), IF_ICMPLT(0xa1), IF_ICMPGE(0xa2), IF_ICMPGT(0xa3), IF_ICMPLE(0xa4), IF_ACMPEQ(
		0xa5
	), IF_ACMPNE(0xa6),
